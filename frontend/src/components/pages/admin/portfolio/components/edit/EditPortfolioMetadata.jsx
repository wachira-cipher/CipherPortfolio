        ...
        <>
                ...
                <div className="col-sm-6">
                    ...
                    <div className="mb-3">
                        ...
                        <input
                            ...
                            className={`form-control ${errors.projectDate ? "is-invalid" : ""
                                }`}
            ...
            <div className="mb-3">
                ...
                <textarea
                    ...
                    className={`form-control ${errors.challenge ? "is-invalid" : ""
                        }`}
...
export default EditPortfolioMetadata;