    ...
    return (
        ...
        <>
            ...
            <div
                ...
                className={`dropzone border rounded p-4 ${errors.images
                        ?
                        "border-danger"
                        :
                        ""
            ...
            >
                ...
                <div className="dz-message needsclick text-center">
                    ...
                    <h4>
                        ...
                        Drop service images here or click to upload
...

                                {
                                    image.type === "new" && (
                                        ...
                                        <span
                                            ...
                                            className="badge bg-success position-absolute bottom-0 start-0"
