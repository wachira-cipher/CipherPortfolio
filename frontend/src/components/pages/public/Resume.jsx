  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const skillsResponse = await getSkills(1, 100);
        ...
        toast.error("Failed loading resume");
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) {
    return (
      <section className="resume section">
        <div className="container text-center">Loading resume...</div>
      </section>
    );
  }
    ...
    return (
      <section className="resume section">
        <div className="container section-title" data-aos="fade-up">
          ...
          <p>
            A summary of my academic background, professional journey, technical
            expertise, and experience building modern digital solutions.
          </p>
        </div>
        <div className="container text-center">
          Resume not available.Check back later
        </div>
      </section>
    );
  }
