!(function (o) {
  ...
  (o("#side-menu").metisMenu(),
    ...
    /*
|--------------------------------------------------------------------------
| React Right Sidebar Support
|--------------------------------------------------------------------------
*/

    o(document).on("click", ".right-bar-toggle", function (t) {
      t.preventDefault();

      console.log(
        "Template right sidebar toggle disabled - React controls this",
      );
    }),
    /*
|--------------------------------------------------------------------------
| Do not remove right-bar-enabled automatically
| React AdminLayout controls this state
|--------------------------------------------------------------------------
*/

    o(document).off("click", "body"),
    (function () {
